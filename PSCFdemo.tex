...
\end{Sinput}
\end{Schunk}
an additional argument, \verb@colorvar@, can be passed to \verb@add_diagnosefn@, which will color the trajectories. For instance, \verb@sub(``.+\\_([0-9]+)$'',''\\1'',rownames(coords(trajectories)))@ will color by altitude.
